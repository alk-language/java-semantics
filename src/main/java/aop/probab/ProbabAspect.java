...
public class ProbabAspect {
    ...
    @Before("execution(* execution.helpers.NonDeterministic.getRandom(..))")
    ...
    @Before("execution(* execution.helpers.NonDeterministic.choose(..)) || " +
            "execution(* execution.helpers.NonDeterministic.chooseST(..)) ")
    public void setProbabilisticAlgorithmToChose(JoinPoint joinPoint)
    {
        Analysis.algorithm_type = "nedeterminist";
    }

    @After("execution(* execution.helpers.NonDeterministic.getRandom(..))")
