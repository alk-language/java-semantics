...
public class DemoAspect {
    ...
    {
        System.out.println("****LoggingAspect.logBeforeAdd() : " + joinPoint.getSignature().getName());
    }

    @Before("execution(* impl.types.AlkValue.subtract(..))")
    public void logBeforeMinus(JoinPoint joinPoint)
    {
        System.out.println("****LoggingAspect.logBeforeSubtract() : " + joinPoint.getSignature().getName());
    }
