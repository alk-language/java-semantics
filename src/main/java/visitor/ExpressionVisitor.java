...
{
    private final ExpressionInterpreter<T> expressionInterpreter;
    ...
    @Override
    public T visit(ComponentAST ctx)
    {
        throw new InternalException("Can't visit a component (part of struct) AST.");
    }
