...
public class BasicExpressionInterpreter
implements ExpressionInterpreter<BaseValue>
{
    ...
    public BasicExpressionInterpreter(Environment env, LocationGenerator locationGenerator)
    {
        this.env = env;
