...
implements SMTFunctionSolver
{
    ...
    private FuncDecl<?> getFunc(Sort paramType)
    {
        ...
        {
            FuncDecl fd = alkCtx.ctx.mkFuncDecl("asin", new Sort[]{ paramType }, alkCtx.ctx.getRealSort());
