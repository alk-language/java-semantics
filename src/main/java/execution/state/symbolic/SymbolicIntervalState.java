...
public class SymbolicIntervalState
extends IterableWithIntervalState
{
    public SymbolicIntervalState(Primitive primitive, AST ast, ExecutionPayload payload)
    {
    ...
    public ExecutionState clone(SplitMapper sm) {
        SymbolicIntervalState copy = new SymbolicIntervalState(primitive, tree, payload.clone(sm));
