...
import ro.uaic.info.alk.io.DummyIOManager;
 ...
 * It also serves as an option provider.
 */
public class AlkConfiguration
           ...
           ProbabilityComputer
{
    ...
    public AlkConfiguration clone() {
        AlkConfiguration copy = new AlkConfiguration();
    ...
    {
        probability = probability.multiply(probab, AlkFloat.mc);
    }
