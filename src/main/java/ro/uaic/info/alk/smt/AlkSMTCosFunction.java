...
implements SMTFunctionSolver
{
    ...
    private FuncDecl<?> getFunc(Sort paramType)
    {
        ...
        {
            FuncDecl fd = alkCtx.ctx.mkFuncDecl("cos", new Sort[]{ paramType }, alkCtx.ctx.getRealSort());
