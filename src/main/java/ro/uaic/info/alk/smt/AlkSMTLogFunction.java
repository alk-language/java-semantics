...
implements SMTFunctionSolver
{
    ...
    private FuncDecl<?> getFunc(Sort paramType)
    {
        ...
        {
            FuncDecl fd = alkCtx.ctx.mkFuncDecl("log", new Sort[]{ paramType }, alkCtx.ctx.getRealSort());
