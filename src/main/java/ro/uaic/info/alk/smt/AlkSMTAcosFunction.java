...
implements SMTFunctionSolver
{
    ...
    private FuncDecl<?> getFunc(Sort paramType)
    {
        ...
        {
            FuncDecl fd = alkCtx.ctx.mkFuncDecl("acos", new Sort[]{ paramType }, alkCtx.ctx.getRealSort());
