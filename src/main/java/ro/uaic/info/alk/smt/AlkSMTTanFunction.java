...
implements SMTFunctionSolver
{
    ...
    private FuncDecl<?> getFunc(Sort paramType)
    {
        ...
        {
            FuncDecl fd = alkCtx.ctx.mkFuncDecl("tan", new Sort[]{ paramType }, alkCtx.ctx.getRealSort());
