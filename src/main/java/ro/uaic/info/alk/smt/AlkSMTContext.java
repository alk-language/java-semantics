   ...
   implements DataTypeProvider
{
    ...
    private final Map<AlkBuiltInMethod, SMTMethodSolver> bMethods = new HashMap<>();
    private final Map<AlkBuiltInFunction, SMTFunctionSolver> bFunctions = new HashMap<>();
    ...
    public SMTMethodSolver getBuiltInMethodSolver(AlkBuiltInMethod method)
    {
        if (!bMethods.containsKey(method))
        {
            ...
            switch (method)
            {
                ...
                case POP_BACK: solver = new AlkSMTPopBackMethod(this); break;
                case POP_FRONT: solver = new AlkSMTPopFrontMethod(this); break;
                case PUSH_BACK: solver = new AlkSMTPushBackMethod(this); break;
                case PUSH_FRONT: solver = new AlkSMTPushFrontMethod(this); break;
                case REMOVE_AT: solver = new AlkSMTRemoveAtMethod(this); break;
                case TOP_BACK: solver = new AlkSMTTopBackMethod(this); break;
                case TOP_FRONT: solver = new AlkSMTTopFrontMethod(this); break;
    ...
    public SMTFunctionSolver getBuiltInFunctionSolver(AlkBuiltInFunction fnc)
    {
