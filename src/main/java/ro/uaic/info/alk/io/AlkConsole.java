...
implements IOManager,
           OptionProvider
{
    public static final Option sizeOption = Option.builder("z")
                                                  .longOpt("size")
                                                  .desc("set maximum array size to <arg>")
                                                  .hasArg()
                                                  .type(Integer.class)
                                                  .build();
    ...
    public AlkConsole(String[] args)
    {
        ...
        Option prover = new Option("ro/uaic/info/alk/smt", "ro/uaic/info/alk/smt", true, "define the SMT prover to be used");
        ...
        try
        {
            ...
            {
                AlkArray.MAX_ARRAY = Integer.parseInt(cmd.getOptionValue("size"));
            }
        }
    ...
    {
        return cmd.hasOption("ro/uaic/info/alk/smt");
    }

    @Override
    public String getProver()
    {
        return cmd.getOptionValue("ro/uaic/info/alk/smt");
    }
