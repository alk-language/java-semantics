...
implements SmallStepExpressionInterpreter<SymbolicValueIface>
{
    ...
    @Override
    public SymbolicValueIface evaluateBuiltIn(AlkBuiltInMethod op, SymbolicValueIface factor, List<SymbolicValueIface> params)
    {
        // TODO add support
        return null;
    }
    ...
    @Override
    public SymbolicValueIface interpretContextVar(ContextVar old, String id)
    {
