...
public interface statementListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterEmptyArray(statementParser.EmptyArrayContext ctx);
	/**
	 * Exit a parse tree produced by the {@code EmptyArray}
	 * labeled alternative in {@link statementParser#array}.
	 * @param ctx the parse tree
	 */
	void exitEmptyArray(statementParser.EmptyArrayContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterSetWithInterva(statementParser.SetWithIntervaContext ctx);
	/**
	 * Exit a parse tree produced by the {@code SetWithInterva}
	 * labeled alternative in {@link statementParser#set}.
	 * @param ctx the parse tree
	 */
	void exitSetWithInterva(statementParser.SetWithIntervaContext ctx);
	/**
	 * Enter a parse tree produced by the {@code SetWithSpecl}
	 * labeled alternative in {@link statementParser#set}.
	 * @param ctx the parse tree
	 */
	void enterSetWithSpecl(statementParser.SetWithSpeclContext ctx);
	/**
	 * Exit a parse tree produced by the {@code SetWithSpecl}
	 * labeled alternative in {@link statementParser#set}.
	 * @param ctx the parse tree
	 */
	void exitSetWithSpecl(statementParser.SetWithSpeclContext ctx);
	/**
