...
public interface statementVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitEmptyArray(statementParser.EmptyArrayContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSetWithInterva(statementParser.SetWithIntervaContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSetWithSpecl(statementParser.SetWithSpeclContext ctx);
	/**
